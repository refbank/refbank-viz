...
write_csv(harmonized_datasets[[4]], "harmonized_data.csv")
...
print(names(harmonized_datasets[[1]]))
print(names(harmonized_datasets[[2]]))
print(names(harmonized_datasets[[3]]))
print(names(harmonized_datasets[[4]]))
print(names(harmonized_datasets[[5]]))
print(names(harmonized_datasets[[6]]))
